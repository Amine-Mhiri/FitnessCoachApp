        ...
        <div class="workout__details">
           ...
           <span class="workout__info-data workout__info-data--target">${workout.target}</span>
            ...
            <span class="workout__info-text">Nbr of repetitions : </span>
              <span class="workout__info-data workout__info-data--repetitions">x${workout.repetitions}</span>
            ...
            <span class="workout__info-text">Nbr of sets : </span>
              <span class="workout__info-data workout__info-data--sets">x${workout.sets}</span>
...
[
    "hashchange",
    "load"
].forEach((ev)=>window.addEventListener(ev, showWorkout));
...
},{}]},["aD7Zm","aenu9"], "aenu9", "parcelRequireade5")
